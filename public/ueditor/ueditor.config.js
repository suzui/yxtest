...
(function () {
	window.UEDITOR_HOME_URL = "/public/ueditor/";//编辑器项目路径 ie7下初始为null 需自定义
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/back/uploadByUeditor"             //图片上传提交地址
        ...
        //附件上传配置区
        ,fileUrl:"/back/uploadByUeditor"             //附件上传提交地址
        ...
        //word转存配置区
        ,wordImageUrl:"/back/uploadByUeditor"             //word转存提交地址
        ,wordImagePath:""                       //
